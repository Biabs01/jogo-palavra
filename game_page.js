...
function check(){
    ...
    if(questionTurn == "player1"){
        ...
        document.getElementById("playerQuestion").innerHTML = "Turno de Pergunra - "+ player2Name;
    }
    else{
        questionTurn = "player1";
        document.getElementById("playerQuestion").innerHTML = "Turno de Pergunra - "+ player1Name;
    }
    if(answerTurn == "player1"){
        answerTurn = "player2";
        document.getElementById("playerAnswer").innerHTML = "Turno de Resposta - "+ player2Name;
        ...
        answerTurn = "player1";
        document.getElementById("layerAnswer").innerHTML = "Turno de Resposta - "+ player1Name;
    }
